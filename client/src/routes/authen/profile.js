    ...
    return(
        <div>
            <div className="row">
                <div className="col-md-4 animated fadeIn" key={profile.customerID}>
                    <div className="card">
                        ...
                        <span className="wallet">Currently has {parseInt(user.wallet)} VND in wallet</span>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="buttonbox">
                <button onClick={()=>{navigate("/gethotels")}} className="lButton marbutton"> Book Now!!</button>
                <FormDialog />
            </div>      
        </div>
    )
